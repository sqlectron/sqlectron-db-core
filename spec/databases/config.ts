...
const dbs = {
  ...
  postgresql: {
    ...
    database: postgres.path?.[0] || 'sqlectron',
  },
  redshift: {
    ...
    database: redshift.path?.[0] || 'sqlectron',
  },
  mysql: {
    host: mysql.hostname,
    ...
    database: mysql.path?.[0] || 'sqlectron',
  },
  mariadb: {
    ...
    database: mariadb.path?.[0] || 'sqlectron',
  },
  sqlserver: {
    ...
    database: sqlserver.path?.[0] || 'sqlectron',
  },
  cassandra: {
    host: <string>cassandra.hostname,
    port: cassandra.port || 9042,
    database: cassandra.path?.[0] || 'sqlectron',
  },
};
